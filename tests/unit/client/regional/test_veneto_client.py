...
class TestVenetoClient(unittest.TestCase):
    ...
    def test_get_html_success_no_fmt(self, mock_get):
        ...
        result = self.client.get_html("https://example.com")

        self.assertEqual(result, '<html>Test content</html>')
        mock_get.assert_called_once_with("https://example.com")

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_success_html_fmt_valid(self, mock_get):
        ...
        result = self.client.get_html("https://example.com", fmt='html')

        self.assertEqual(result, '<html>Test content</html>')
        mock_get.assert_called_once_with("https://example.com")

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_success_xml_fmt_valid(self, mock_get):
        ...
        result = self.client.get_html("https://example.com", fmt='xml')

        self.assertEqual(result, '<xml>Test content</xml>')
        mock_get.assert_called_once_with("https://example.com")

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_success_pdf_fmt_valid(self, mock_get):
        ...
        result = self.client.get_html("https://example.com", fmt='pdf')

        self.assertEqual(result, '%PDF-1.4 Test content')
        mock_get.assert_called_once_with("https://example.com")

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_html_fmt_invalid(self, mock_get):
        ...
        with self.assertRaises(SystemExit):
            self.client.get_html("https://example.com", fmt='html')

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_xml_fmt_invalid(self, mock_get):
        ...
        with self.assertRaises(SystemExit):
            self.client.get_html("https://example.com", fmt='xml')

    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_pdf_fmt_invalid(self, mock_get):
        ...
        with self.assertRaises(SystemExit):
            self.client.get_html("https://example.com", fmt='pdf')
    ...
    @patch('tulit.client.regional.veneto.requests.get')
    def test_get_html_http_error(self, mock_get):
